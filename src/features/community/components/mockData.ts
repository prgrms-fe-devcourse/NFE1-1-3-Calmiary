...
const mockPosts: Post[] = [
  {
    id: 1,
    content:
      '요즘 너무 바빠서 제 자신을 돌볼 시간이 없어요. 어떻게 균형을 잡을 수 있을까요? 요즘 너무 바빠서 제 자신을 돌볼 시간이 없어요. 어떻게 균형을 잡을 수 있을까요?요즘 너무 바빠서 제 자신을 돌볼 시간이 없어요. 어떻게 균형을 잡을 수 있을까요?요즘 너무 바빠서 제 자신을 돌볼 시간이 없어요. 어떻게 균형을 잡을 수 있을까요?',
    author: {
      nickname: 'user01',
      profileUrl:
